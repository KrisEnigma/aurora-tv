...
static void show_ok(apps_fragment_t *fragment) {
    ...
    if (idx >= 0 && idx < apps_raw_visible_count(fragment, fragment->apploader_apps)) {
        apps_on_item_focused(fragment, fragment->apploader_apps->items[idx].base.id);
    }
}
